import SolutionTopItem from "./SolutionTopItem";
...
function DoctorsSolutionTop() {
    return (
        <div class="doctors_solution_top">
            ...
            <SolutionTopItem
                title="CRM"
                text="EMR 연동을 통하여 고객관리는 쉽고 간편하게, 카카오톡 사용으로 비용은 저렴하게 사용할
            수 있는 CRM솔루션"
            />
            <SolutionTopItem
                title="LAB"
            ...
            <SolutionTopItem
                title="진료대기"
                text="환자 대기실에서 TV시청/병원홍보영상/건강정보를 제공하면서 호출까지 가능한 진료대기
                솔루션"
            />
            <SolutionTopItem
                title="사전점검"
                text="증가하는 심사고시, 번거로운 심사기준, 복잡한 심사결과 통계 등 심사과 업무 효율화
                솔루션"
            />
            <SolutionTopItem
                title="복약지도"
                text="약사법에 따른 복약지도 의무화 및
            ...
            <SolutionTopItem
                title="SIGN"
                text="오프라인 동의서의 출력/작성/스캔/보관업무를 원스탑으로 해결할 수 있는 전자동의서
                솔루션"
            />
        </div>
    );
